...
@RestController
public class LeaderLearningMaterialController {

    private final LearningMaterialService learningMaterialService;

    public LeaderLearningMaterialController(LearningMaterialService learningMaterialService) {
        this.learningMaterialService = learningMaterialService;
    }

    @PostMapping("/api/v1/leader/groups/{groupId}/materials")
    ...
    @PutMapping("/api/v1/leader/groups/{groupId}/materials/{materialId}")
    @PreAuthorize("@authzService.canManageGroup(authentication, #groupId)")
    ...
    @DeleteMapping("/api/v1/leader/groups/{groupId}/materials/{materialId}")
    @PreAuthorize("@authzService.canManageGroup(authentication, #groupId)")
